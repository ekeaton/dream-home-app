    ...
    render() {
        return (
            ...
            <div class="boardz beautiful">
              ...
              <ul>
                  <li>
                  <img src="https://bit.ly/2OjchSP" alt="kitchen"/>
                    <p>Paint Sample</p>
                   <button class="button button5">+</button>       
                  </li>
                  <li>
                  <img src="https://bit.ly/30FiBFm" alt="kitchen"/>
                    <p>Flooring</p>
                   <button class="button button5">+</button>   
                  </li>
              </ul>
              <ul>
                  <li>
                  <img src="https://bit.ly/2Y0SFSX" alt="kitchen"/>
                    <p>Lighting</p>
                   <button class="button button5">+</button>   
                  </li>
                  <li>
              ...
              <ul>
                  <li>
                    <img src="https://bit.ly/2Lq8Gji" alt="kitchen"/>
                    <p>Appliance</p>
                   <button class="button button5">+</button>   
                  </li>
                  <li>
                    <img src="https://bit.ly/2XUTEnC" alt="kitchen"/>
                      <p>Cabinets</p>
                   <button class="button button5">+</button>   
                  </li>
              </ul>
